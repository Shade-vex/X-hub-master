local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Shade-vex/X-hub-master/refs/heads/main/menuXhubV2.lua')))()

local Window = OrionLib:MakeWindow({Name = "X hub Master V2", HidePremium = false, SaveConfig = true, ConfigFolder = "dxl_bf"})
